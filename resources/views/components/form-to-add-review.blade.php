<div class="card">
    <div class="card-body fs-5">
        <h2 class="card-title fs-3">Pievienot atsauksmi par lietotāju {{$user->first_name}} {{$user->last_name}}</h2>
        ...
        <form method="POST" action="{{route('review.add', $user)}}" enctype="multipart/form-data">
            ...
            <!-- Buttons -->
            <div class="row mt-3">
                <p class="col-auto ml-2"><button type="submit" class="btn btn-success">Pievienot atsauksmi</button></p>
